...
shared (deployer) persistent actor class EvmDaoBridgeCanister<system>(
  ...
  public shared (msg) func icrc149_update_snapshot_contract_config(contract_address : Text, config : ?EvmDaoBridge.SnapshotContractConfig) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_update_execution_contract_config(contract_address : Text, config : ?EvmDaoBridge.ExecutionContractConfig) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_update_icp_method_config(canister : Principal, method : Text, config : ?EvmDaoBridge.ICPMethodConfig) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_update_admin_principal(principal : Principal, is_admin : Bool) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_update_evm_rpc_canister(canister_id : Principal) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  // Proposal Management
  public shared (msg) func icrc149_create_proposal(proposal_args : Service.CreateProposalRequest) : async {
    #Ok : Nat;
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_vote_proposal(vote_args : EvmDaoBridge.VoteArgs) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_execute_proposal(proposal_id : Nat) : async {
    #Ok : Text;
    #Err : Text;
  } {
  ...
  // User Vote Queries
  public query func icrc149_get_user_votes(requests : [{ proposal_id : Nat; user_address : Text }]) : async [{
    proposal_id : Nat;
    user_address : Text;
    vote : ?{ #Yes; #No; #Abstain };
  }] {
  ...
  public query func icrc149_get_user_vote(proposal_id : Nat, user_address : Text) : async ?{
    #Yes;
    #No;
    #Abstain;
  } {
  ...
  // Admin
  public shared (msg) func icrc149_set_controller(new_controller : Principal) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared func test_add_snapshot(contract_address : Text, block_number : Nat, root_hash : Text) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public query func test_get_snapshot_info(contract_address : Text) : async ?{
    block_number : Nat;
    root_hash : Text;
  } {
  ...
  public shared (msg) func icrc149_set_default_snapshot_contract(contract_address : ?Text) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_update_proposal_duration(duration_nanoseconds : Nat) : async {
    #Ok : ();
    #Err : Text;
  } {
  ...
  public shared (msg) func test_parallel_rpc_calls(rpc_canister_id : Principal) : async {
    #Ok : (Nat, Nat, Nat);
    #Err : Text;
  } {
  ...
  public shared (msg) func icrc149_admin_fix_stuck_proposal(proposal_id : Nat) : async {
    #Ok : Text;
    #Err : Text;
  } {
