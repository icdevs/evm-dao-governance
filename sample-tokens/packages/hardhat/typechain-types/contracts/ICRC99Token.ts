...
export interface ICRC99TokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ICRC99Token extends BaseContract {
  connect(runner?: ContractRunner | null): ICRC99Token;
  waitForDeployment(): Promise<this>;

  interface: ICRC99TokenInterface;
